from ofrapi import __series_full, __series_multifull, __series_dataset, __categories
from ofrapi.hfm import __api

__all__ = ["series_full", "series_multifull", "series_dataset", "categories"]
...
def categories(category: str):
    ...
    """
    return __categories(__api, category)
